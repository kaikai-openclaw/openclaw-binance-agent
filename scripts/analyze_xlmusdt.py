...
print("=" * 60)
print("深度分析 XLMUSDT (TradingAgents)")
print("=" * 60)
...
# 4. 伪造 Skill-1 输出（只测 XLMUSDT）
now = datetime.now(timezone.utc).isoformat()
s1_out_id = store.save(
    "skill1_collect",
    {
        "pipeline_run_id": "xlmusdt-analysis",
        "candidates": [
            {
                "symbol": "XLMUSDT",
                "heat_score": 8.5,
...
print("\n[run] 开始深度分析 XLMUSDT (可能需要 2-5 分钟)...")
print("-" * 60)
